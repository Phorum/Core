 ...
 */
require_once "./include/open_id/Yadis/PlainHTTPFetcher.php";
require_once "./include/open_id/Yadis/ParanoidHTTPFetcher.php";

/**
 * Need this for parsing HTML (looking for META tags).
 */
require_once "./include/open_id/Yadis/ParseHTML.php";

/**
 * Need this to parse the XRDS document during Yadis discovery.
 */
require_once "./include/open_id/Yadis/XRDS.php";
 ...
 *
 * <pre>  require_once "./include/open_id/Yadis/Yadis.php";</pre>
 *
