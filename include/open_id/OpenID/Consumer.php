 ...
 */
require_once "./include/open_id/OpenID.php";
require_once "./include/open_id/OpenID/Message.php";
require_once "./include/open_id/OpenID/HMACSHA1.php";
require_once "./include/open_id/OpenID/Association.php";
require_once "./include/open_id/OpenID/CryptUtil.php";
require_once "./include/open_id/OpenID/DiffieHellman.php";
require_once "./include/open_id/OpenID/KVForm.php";
require_once "./include/open_id/OpenID/Nonce.php";
require_once "./include/open_id/OpenID/Discover.php";
require_once "./include/open_id/Yadis/Manager.php";
require_once "./include/open_id/Yadis/XRI.php";
