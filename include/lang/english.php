<?php
    ...
    $PHORUM["DATA"]["LANG"]=array(
        ...
        "EmailReplies"          =>      "Send replies to this topic to me via email",
        "Email"                 =>      "Email",
...
to write Phorum modules and on how to use the external and scheduled hooks.\n\n",
        ...
        "ThreadViewList"        =>      "Threading Override - List",
        "ThreadViewRead"        =>      "Threading Override - Read",
        ...
        "ViewThreaded"          =>      "View Topics Threaded",
        "Views"                 =>      "Views",
        "Views_Subject"         =>      "views",
