<?php
    ...
    $PHORUM["DATA"]["LANG"]=array(
        ...
        "AttachFileTypes"       =>      "Valid attachments:",
        "AttachFileSize"        =>      "No file can be larger than",
        "AttachMaxAttachments"  =>      "more files can be attached to this message",
        ...
        "ErrBannedIP"           =>      "You have no access to this page, because your IP address, domain or ISP has been blocked. Please contact the forum administrators.",
        "ErrBannedName"         =>      "You have no access to this page, because the name you entered has been banned from use. Please use a different name when posting or contact the forum administrators.",
        "ErrBannedEmail"        =>      "You have no access to this page, because the email address you entered has been banned from use. Please use a different email address when posting or contact the forum administrators.",
        "ErrBannedUser"         =>      "You have no access to this page, because this user has been banned from use.",
