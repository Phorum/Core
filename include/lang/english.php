<?php
    ...
    $PHORUM["DATA"]["LANG"]=array(
        ...
        "MergeThreadCancel"     =>      "Cancel Merge Topic",
        "MergeThreads"          =>      "Merge Topics",
        "MergeThreadAction"     =>      "The following topics can be merged into one topic",
        "MergeThreadInfo"       =>      "Now go to the topic which should be merged with the selected topic and select 'Merge Topic' again.",
