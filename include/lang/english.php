<?php
    ...
    $PHORUM["DATA"]["LANG"]=array(
        ...
        "AttachMaxAttachments"  =>      "The maximum number of files you can attach is",
    ...
    "MoveAnnouncementForbidden" => "Announcement threads cannot be moved.",
        ...
        "Posts"                 =>      "Posts",
        "Preview"               =>      "Preview",
        "PreviewExplain"        =>      "Below you can see how your message will be displayed in the forum.<br/>If you wish, you can still edit your message.",
