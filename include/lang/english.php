<?php
    ...
    $PHORUM["DATA"]["LANG"]=array(
        ...
        "ErrRegisterdName"      =>      "The username you entered is already registered by another user. If you are that user, please login.  Otherwise, please use another name.",
        ...
        "OpenID"                =>      "OpenID",
        "OpenIDComplete"        =>      "Complete OpenID Registration",
        "OpenIDCompleteExplain" =>      "Your OpenID has been confirmed.  Please fill in the following information to complete your registration.",
        "OpenIDLogin"           =>      "Log in using your OpenID",
        "OpenIDInvalid"         =>      "The OpenID you entered appears to be invalid.",
        "OpenIDRedirect"        =>      "There was an error contacting your OpenID server.",
        "OpenIDUnknown"         =>      "An unknown error was encountered while verifying your OpenID.",
        "OpenIDWhat"            =>      "What is OpenID?",
        "Options"               =>      "Options",
        ...
        "RegApprovedEmailBody"  =>      "Your $PHORUM[title] account has been approved.  You can login to $PHORUM[title] at ".$phorum->url(PHORUM_LOGIN_URL)."\n\nThanks, $PHORUM[title]",
