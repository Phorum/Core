<?php
    ...
    $PHORUM["DATA"]["LANG"] = array(
        ...
        "MergeThreadUpdateSubjects" =>  "Update the subject of all messages in Topic 2 to match the subject of Topic 1?",
   ...
   [options]               When running the \"external\" hook for a module,
        ...
        "SplitThreadNewSubject" =>      "New subject for the thread",
        "SplitThreadUpdateSubjects" =>  "Update the subject of all messages in the split off thread to match the new subject?",
