...
/**
 * This script implements the mysqli extension for the MySQL database layer.
 */

/**
 * The PhorumMysqlDB_mysqli class, which implements the mysqli extension
 * for the MySQL database layer.
 */
class PhorumMysqlDB_mysqli extends PhorumDB
{
    /**
