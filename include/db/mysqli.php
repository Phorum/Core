    ...
    if (count($message) > 0){
        ...
        foreach($message as $field => $value){
            if (is_numeric($value) && !in_array($field,$PHORUM['string_fields'])){
                ...
                $fields[] = "$field='".mysqli_real_escape_string ($conn, serialize($value))."'";
            }else{
...
function phorum_db_create_tables()
{
    ...
    if(empty($err)){
        ...
        // hooks
        mysqli_query($conn, "INSERT INTO {$PHORUM['settings_table']} (`name`, `type`, `data`) VALUES ('hooks','S','a:1:{s:6:\"format\";a:2:{s:4:\"mods\";a:2:{i:0;s:7:\"smileys\";i:1;s:6:\"bbcode\";}s:5:\"funcs\";a:2:{i:0;s:18:\"phorum_mod_smileys\";i:1;s:14:\"phorum_bb_code\";}}}')");

        // enabled modules
        mysqli_query($conn, "INSERT INTO {$PHORUM['settings_table']} (`name`, `type`, `data`) VALUES ('mods','S','a:4:{s:4:\"html\";s:1:\"0\";s:7:\"replace\";s:1:\"0\";s:7:\"smileys\";s:1:\"1\";s:6:\"bbcode\";s:1:\"1\";}')");
