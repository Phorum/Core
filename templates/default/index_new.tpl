...
{ELSE}
<tr class="forum">
<td class="forum-name"><a href="{FORUMS->url}">{FORUMS->name}</a><p>{FORUMS->description}</p><small>{LANG->Options}: <a href="{FORUMS->url_markread}">{LANG->MarkForumRead}</a>&nbsp;&bull;&nbsp;<a href="{FORUMS->url_rss}">{LANG->RSS}</a></td>
