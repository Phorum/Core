...
{IF MESSAGECOUNT}
  {LOOP MESSAGES}
    <tr>
      ...
      <td class="PhorumListTableRow"><a href="{MESSAGES->read_url}"><strong>{MESSAGES->subject}</strong></a>{IF NOT MESSAGES->read_flag}<span class="PhorumNewFlag">&nbsp;{LANG->newflag}</span>{/IF}</td>
