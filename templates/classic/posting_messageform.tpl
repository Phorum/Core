<div class="PhorumStdBlockHeader PhorumNarrowBlock">
  <table class="PhorumFormTable" cellspacing="0" border="0">
    ...
    <tr>
      ...
      <td><input type="text" id="subject" name="subject" size="50" value="{POSTING->subject}" /></td>
    </tr>
...
<div class="PhorumStdBlock PhorumNarrowBlock">
  <textarea id="body" name="body" rows="15" cols="50" style="width: 99%">{POSTING->body}</textarea>
  {IF MODERATED}
