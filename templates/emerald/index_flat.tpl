            ...
            <tr>
                ...
                {ELSE}
                    <td width="55%">
                        ...
                        {IF FORUMS->URL->MARK_READ}<a class="icon icon-tag-green" href="{FORUMS->URL->MARK_READ}" onclick="return Phorum.markRead('forums', {FORUMS->forum_id})">{LANG->MarkForumRead}</a>&nbsp;&nbsp;&nbsp;{/IF}
