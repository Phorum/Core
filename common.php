...
// It's up here, so we can override it from the phorum PHP extension.
// Because of the function_exists check, this function will be 
// created at runtime (and not at parse/compile time) if the extension is
// not loaded. Therefore we have to make sure that at it's created before
// its first invocation.
if (!function_exists('phorum_get_url')) { function phorum_get_url()
{
