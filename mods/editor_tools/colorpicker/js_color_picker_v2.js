	...
	************************************************************************************************************/	
		...
		do{			
			if(subDiv.tagName=='DIV' && subDiv.className!='colorPickerCloseButton'){
				if(subDiv==thisObj){
                    ...
                    /* Changed for Phorum editor tools */
					img.src = "./mods/editor_tools/colorpicker/images/tab_right_active.gif"
                    ...
                    /* Changed for Phorum editor tools */
					img.src = "./mods/editor_tools/colorpicker/images/tab_right_inactive.gif";
					if(activeColorDiv)
	...
	function createColorPickerTopRow(inputObj){
		...
		for(var no=0;no<tabs.length;no++){			
            ...
            /* Changed for Phorum editor tools */
			tabImg.src = "./mods/editor_tools/colorpicker/images/tab_right_" + suffix + ".gif";
