<table cellspacing="0" class="list announcements">
    ...
    {LOOP ANNOUNCEMENTS}
        ...
        <tr>
            <td width="1%"><a href="{read_url}" title="{title}"><img class="announcement-new-flag-icon-{ANNOUNCEMENTS->forum_id}-{ANNOUNCEMENTS->thread}-{ANNOUNCEMENTS->message_id}" src="{URL->TEMPLATE}/images/{icon}.png" width="16" height="16" border="0" alt="{title}" /></a></td>
