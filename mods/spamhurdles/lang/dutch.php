...
(
    ...
    "PostingRejected" =>
        "De gegevens die u naar de server heeft gestuurd zijn geweigerd,
    ...
    "ContactSiteOwner" =>
        "Wanneer u problemen blijft houden, neem dan contact op met
