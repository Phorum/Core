...
create_spamhurdle_options($frm, 'posting', array(
    "none"      => "Disable hurdle",
...
create_spamhurdle_options($frm, 'register', array(
    "none"      => "Disable hurdle",
    "all"       => "Enable hurdle"
));
...
create_spamhurdle_options($frm, 'pm', array(
    "none"      => "Disable hurdle",
    "all"       => "Enable hurdle"
));
...
function create_spamhurdle_options($frm, $section, $statusspec)
{
    global $PHORUM;
